...
import com.poc.filter.FilterreactiveApp;
import com.poc.filter.config.AsyncSyncConfiguration;
import com.poc.filter.config.EmbeddedSQL;
...
@SpringBootTest(classes = { FilterreactiveApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
