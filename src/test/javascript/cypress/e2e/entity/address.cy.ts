...
describe('Address e2e test', () => {
  ...
  const addressSample = { street: 'Elvis Groves' };
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      cy.get(`[data-cy="street"]`).type('Wolff Track').should('have.value', 'Wolff Track');

      cy.get(`[data-cy="city"]`).type('South Tyrique').should('have.value', 'South Tyrique');

      cy.get(`[data-cy="state"]`).type('firewall user-centric JSON').should('have.value', 'firewall user-centric JSON');

      cy.get(`[data-cy="zip"]`).type('21892').should('have.value', '21892');
