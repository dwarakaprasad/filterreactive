...
describe('Customer e2e test', () => {
  ...
  const customerSample = { name: 'Kids cross-platform' };
  ...
  describe('Customer page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Customer page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Customer');
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      ...
      cy.get(`[data-cy="age"]`).type('24250').should('have.value', '24250');

      cy.get(`[data-cy="distanceTravelled"]`).type('21926').should('have.value', '21926');

      cy.get(`[data-cy="amountSpent"]`).type('20603').should('have.value', '20603');

      cy.get(`[data-cy="amountSaved"]`).type('83400').should('have.value', '83400');

      cy.get(`[data-cy="amountEarned"]`).type('38858').should('have.value', '38858');

      cy.get(`[data-cy="happyPerson"]`).should('not.be.checked');
      cy.get(`[data-cy="happyPerson"]`).click().should('be.checked');

      cy.get(`[data-cy="dob"]`).type('2022-09-23T14:18').blur().should('have.value', '2022-09-23T14:18');

      cy.get(`[data-cy="createdDate"]`).type('2022-09-23').blur().should('have.value', '2022-09-23');

      cy.get(`[data-cy="travelDate"]`).type('2022-09-23T13:22').blur().should('have.value', '2022-09-23T13:22');

      cy.get(`[data-cy="travelTime"]`).type('PT55M').blur().should('have.value', 'PT55M');

      cy.get(`[data-cy="customerType"]`).select('VP');
