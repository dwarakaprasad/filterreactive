      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            distanceTravelled: expect.any(Object),
            amountSpent: expect.any(Object),
            amountSaved: expect.any(Object),
            amountEarned: expect.any(Object),
            happyPerson: expect.any(Object),
            dob: expect.any(Object),
            createdDate: expect.any(Object),
            travelDate: expect.any(Object),
